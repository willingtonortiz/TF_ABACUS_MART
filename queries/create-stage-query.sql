...
GO
CREATE TABLE [dbo].[Mercancias](
	[mercancia_id] [int] IDENTITY(1,1) NOT NULL,
	[Resumen_Mercancia] [nvarchar](100) NOT NULL,
)
GO
CREATE TABLE [dbo].[Estado_Ordenes](
	[estado_orden_id] [int] IDENTITY(1,1) NOT NULL,
...
INSERT INTO [dbo].[Rango_CIF] (Nombre, Valor_Minimo, Valor_Maximo)
	VALUES ('R1', 0, 20000),
			('R2', 20001, 40000),
			('R3', 40001, 60000),
			('R4', 60001, 80000),
